...
- **Dashboard design**: BI-style interactive dashboards (KPI cards, trend lines, comparative bar charts) built to the same data model a live Power BI or Tableau report would use, with a written build guide in each project's README for recreating it as a live report
